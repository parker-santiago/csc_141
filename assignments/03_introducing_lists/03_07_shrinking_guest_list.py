...
print("\nDue to unforseen circumstances, I can only invite two people to my dinner party.\n")

print(f"I'm sorry {people.pop(5)}, but I have to uninvite you from my dinner party.")
print(f"I'm sorry {people.pop(4)}, but I have to uninvite you from my dinner party. You gotta understand.")
print(f"I'm sorry {people.pop(2)}, but I have to uninvite you from my dinner party.")
print(f"I'm sorry {people.pop(0)}, but I have to uninvite you from my dinner party.")

print(f"\n{people[0]}, youre still invited to the party! You still have to cook though.")
print(f"{people[1]}, you're still invited to the party! And we still got Ronald on the grill!")
